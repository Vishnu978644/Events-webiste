...
const AdminCorpGallery = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:5000/cogallery")
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleSaveSelectedGallery = () => {
        ...
        const url = _id ? `http://localhost:5000/cogallery/${_id}` : `http://localhost:5000/cogallery`;
    ...
    const deleteGallery = (id) => {
        ...
        if (window.confirm("Are you sure you want to delete this gallery set?")) {
            ...
            fetch(`http://localhost:5000/cogallery/${id}`, { method: "DELETE" })
                .then(res => {
    ...
    return (
        <div className="p-6 min-h-screen bg-gray-50">
            ...
            <div className="mb-10 text-center">
                ...
                <select
                    className="border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-pink-400"
                    defaultValue=""
                        ...
                        {galleries.length === 0 ? (
                            ...
                            galleries.map((g) => (
                                <div
                                    ...
                                    key={g._id || g.main}
                                    className={`p-3 rounded-lg flex items-center justify-between cursor-pointer transition-all border ${selectedGallery?._id === g._id
...
export default AdminCorpGallery;