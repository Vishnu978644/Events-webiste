    ...
    <div className="p-6">
      ...
      <div className="flex justify-center mb-10">
        ...
        >
          ...
          <option value="/admin/categories/heroslide">Hero Slide Images</option>
          <option value="/admin/categories/wedding-flora">Wedding Flora Images</option>
          <option value="/admin/categories/recentimages">Recent Corp Images</option>
        </select>
      </div>
      {/* ----------------------------------------------------------------- */}
