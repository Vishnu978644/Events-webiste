...
const API_URL = 'http://localhost:5000/groommakeup'; 
    ...
    return (
        <div className='p-4'>
            ...
            <div className='flex items-center justify-between'>
                <h1 className='font-bold text-2xl font-music mt-8'>Grooms Makeup Count ({images.length})</h1>
            </div>
