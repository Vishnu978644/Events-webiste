...
const API_BASE_URL = 'http://localhost:5000/decoration'; 
...
const WedDecorationAdmin = () => {
    ...
    return (
        <div className="mt-5 font-music font-bold text-[20px] p-4">
            ...
            <h2 className="text-3xl font-extrabold text-pink-600 mb-6">Wedding Hall Decoration</h2>
...
export default WedDecorationAdmin;